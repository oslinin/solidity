...
describe("Exchange", () => {
    ...
    describe("addLiquidity", async () => {
        describe("empty reserves", async () => {
            ...
            it("mints LP tokens", async () => {
                ...
                expect(await exchange.balanceOf(owner.address)).to.eq(
                    toWei(100)
                )
    ...
    describe("ethToTokenSwap", async () => {
        ...
        it("allows zero swaps", async () => {
            await exchange.connect(user).ethToTokenSwap(toWei(0), {
                value: toWei(0),
            })
    ...
    describe("tokenToTokenSwap", async () => {
        it("swaps token for token", async () => {
            ...
            await exchange2.connect(user).addLiquidity(toWei(1000), {
                value: toWei(1000),
            })
